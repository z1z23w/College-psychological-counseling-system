...
"[project]/app/data:b4c32c [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:b2d3f4 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b2d3f4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:b2d3f4 [app-client] (ecmascript) <text/javascript>");
...
function PsychTestModal({ appointmentId, onSuccess, onCrisis }) {
    ...
    const handleSubmit = async ()=>{
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b2d3f4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["submitPsychTest"])(appointmentId, answers);
        if (res.success) {
            setOpen(false);
            onSuccess(); // 刷新列表
            // ✅ 核心逻辑：如果是高风险，提醒并触发弹窗
            if (res.isHighRisk) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("测评提交成功，感谢您的配合。");
            }
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b4c32c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:b4c32c [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4b4e80__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:4b4e80 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$91ba68__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:91ba68 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$33e512__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:33e512 [app-client] (ecmascript) <text/javascript>");
...
一、咨询性质
心理咨询是咨询师运用心理学专业知识和技术，帮助来访者通过自我探索解决心理困扰、促进个人成长的过程。咨询效果取决于咨询师的专业水平和来访者的主动参与。
...
三、保密例外
在以下特殊情况下，为了保护您和他人的安全，咨询师有权打破保密原则，向相关部门或监护人寻求协助：
1. 您有明显的自杀企图或自伤行为，且风险较高时；
2. 您有伤害他人的冲动或行为，危及公共安全时；
3. 涉及未成年人受虐待或其他法律规定的强制报告情形。

四、您的权利与义务
1. 您有权了解咨询师的专业背景，有权随时提出中止咨询。
2. 请您真诚地与咨询师交流，按时出席预约。如需取消或改期，请提前24小时在系统中操作。
3. 咨询过程中可能会引发情绪波动，这是成长的正常过程，请及时与咨询师沟通。
...
function BookingPage() {
    ...
    const loadData = ()=>{
        if (currentUser?.id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b4c32c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselors"])().then(setCounselors);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$91ba68__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAppointments"])(currentUser.id, 'student').then(setMyAppointments);
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingPage.useEffect": ()=>{
            async function fetchSlots() {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$33e512__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselorSchedule"])(targetCounselorId);
                if (res.success) {
    ...
    const handleCrisisTrigger = ()=>{
        ...
        if (counselors.length > 0) {
            ...
            // 危机干预可以跳过同意书，或者依然要求同意，这里假设依然需要同意
            setHasAgreed(false);
            setFormData((prev)=>({
                    ...prev,
                    problemType: '危机干预',
    ...
    const handleBook = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4b4e80__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createAppointmentWithDetails"])({
        ...
        if (res.success) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("申请已提交！请等待咨询师确认。");
            setActiveTab("history");
            handleDialogChange(false, null); // 关闭弹窗
            setFormData({
                idCard: '',
                studentIdNum: '',
                phone: '',
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                                    ...
                                                    children: !hasAgreed ? // === 第一步：知情同意书 ===
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogTitle"], {
                                                                        className: "flex items-center gap-2 text-xl text-[#2C3E50]",
                                                                        children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                                                        children: "请仔细阅读以下条款，确认同意后方可进行预约。"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/student/booking/page.tsx",
                                                                        lineNumber: 202,
                                                                        columnNumber: 33
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex-1 overflow-y-auto p-4 my-2 border rounded-lg bg-slate-50 text-sm leading-7 text-slate-700 whitespace-pre-wrap",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogFooter"], {
                                                                className: "sm:justify-between items-center gap-4 border-t pt-4",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "text-xs text-slate-400",
                                                                        children: "* 您的隐私将受到法律和职业伦理的严格保护"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/student/booking/page.tsx",
                                                                        lineNumber: 212,
                                                                        columnNumber: 33
...
//# sourceMappingURL=_318513ba._.js.map