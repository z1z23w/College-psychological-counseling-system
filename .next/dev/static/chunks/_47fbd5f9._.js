...
"[project]/app/data:bacc8b [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$bacc8b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:bacc8b [app-client] (ecmascript) <text/javascript>");
;
...
function SchedulePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SchedulePage.useEffect": ()=>{
            async function loadData() {
                if (currentUser?.id) {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$bd152f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselorSchedule"])(currentUser.id);
                    if (res.success) {
                        const map = {};
                        // 转换后端数据到前端 Map
                        res.data.forEach({
    ...
    const handleSave = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$bacc8b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateSchedule"])(currentUser.id, slotsToSave);
        if (res.success) {
...
//# sourceMappingURL=_47fbd5f9._.js.map