...
"[project]/app/data:7970e8 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7970e8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:7970e8 [app-client] (ecmascript) <text/javascript>"); // ✅ 引入后端验证
...
function AuthPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            // 1. 调用后端数据库验证
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7970e8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["loginAction"])(formData.username, formData.role);
            if (res.success) {
                // 2. 验证通过，把用户信息存到前端状态
...
//# sourceMappingURL=_78ee1efd._.js.map