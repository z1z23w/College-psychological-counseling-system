...
"[project]/app/data:dfd9c8 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:d0b86f [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
// ✅ 引入后端 Actions
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$dfd9c8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:dfd9c8 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d0b86f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:d0b86f [app-client] (ecmascript) <text/javascript>");
;
...
function ContentPage() {
    ...
    async function loadData() {
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$dfd9c8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getArticles"])();
    ...
    const handleDelete = async (id)=>{
        if (confirm('确定要永久删除这篇文章吗？')) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d0b86f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteArticle"])(id);
            if (res.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('文章已删除');
                // 重新加载列表（或者直接在本地过滤掉）
...
_s(ContentPage, "ByfW2W02M1Fj4gKraM3ZQ6w4KbM=");
_c = ContentPage;
var _c;
...
//# sourceMappingURL=_aa84994c._.js.map