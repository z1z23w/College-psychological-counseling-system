...
"[project]/app/data:7f7cfb [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7f7cfb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:7f7cfb [app-client] (ecmascript) <text/javascript>");
;
...
function ArticleEditor() {
    ...
    const [category, setCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('自我成长');
    ...
    // ✅ 新增：图片相关的状态
    const [imagePreview, setImagePreview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // 用于显示和存储Base64
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // 用于触发隐藏的input
    // ✅ 新增：处理图片上传
    const handleImageUpload = (e)=>{
        ...
        if (file.size > 2 * 1024 * 1024) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("图片过大", {
    ...
    const handlePublish = async ()=>{
        if (!title.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("请输入文章标题");
            return;
        }
        if (!content.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("请输入正文内容");
            return;
        }
        setLoading(true);
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7f7cfb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createArticle"])({
                title,
                category,
                content,
            ...
            if (result.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("文章发布成功！");
                setTimeout(()=>{
                    // 返回上一页或者去列表页
                    router.back();
                }, 500);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("发布失败", {
                    description: "数据库写入错误"
                });
            }
        } catch (error) {
...
_s(ArticleEditor, "UY/fC3YkMy1p8ZuK6Oi7SbtZD4A=", false, function() {
    return [
...
//# sourceMappingURL=_00ac442e._.js.map