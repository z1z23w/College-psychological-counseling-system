...
"[project]/app/data:5109d1 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
// ✅ 引入后端所有函数
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$5109d1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:5109d1 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$81a828__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:81a828 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f010ff__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:f010ff [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$6fae3f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:6fae3f [app-client] (ecmascript) <text/javascript>");
;
...
function UsersPage() {
    ...
    async function loadData() {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$81a828__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUsers"])();
        if (res.success) {
            setUsers(res.data);
        }
        setIsLoading(false);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (editingId) {
            // 编辑模式
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$6fae3f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUser"])(editingId, formData);
        } else {
            // 新增模式
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$5109d1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createUser"])(formData);
        }
    ...
    const handleDelete = async (id, userName)=>{
        if (confirm(`确定要永久删除用户 "${userName}" 吗？此操作不可恢复。`)) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f010ff__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteUser"])(id);
            if (res.success) {
...
//# sourceMappingURL=_6fe8b09e._.js.map