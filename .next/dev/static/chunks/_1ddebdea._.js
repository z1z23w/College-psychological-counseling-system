        ...
        if (step < selectedTest.questions.length - 1) {
            ...
            if (currentUser?.id) {
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$cae1f9__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAssessment"])(currentUser.id, total, resultText // ✅ 将具体的量表名称和风险等级存入结果字段
                    );
...
//# sourceMappingURL=_1ddebdea._.js.map