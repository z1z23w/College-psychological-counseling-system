...
"[project]/app/data:9b6ed3 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:526c4c [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$526c4c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:526c4c [app-client] (ecmascript) <text/javascript>");
...
function PsychTestModal({ appointmentId, onSuccess, onCrisis }) {
    ...
    const handleSubmit = async ()=>{
        setSubmitting(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$526c4c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["submitPsychTest"])(appointmentId, answers);
            if (res.success) {
                setOpen(false);
                onSuccess(); // 刷新列表状态
                // 如果是高风险，提醒并触发绿色通道逻辑
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9b6ed3__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:9b6ed3 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$dd6b93__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:dd6b93 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9ca8e0__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:9ca8e0 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$cd048d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:cd048d [app-client] (ecmascript) <text/javascript>");
...
function BookingPage() {
    ...
    const loadData = ()=>{
        if (currentUser?.id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9b6ed3__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselors"])().then(setCounselors);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9ca8e0__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAppointments"])(currentUser.id, 'student').then(setMyAppointments);
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingPage.useEffect": ()=>{
            async function fetchSlots() {
                ...
                setAvailableSlots([]);
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$cd048d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAvailableSlotsForDate"])(targetCounselorId, selectedDate.toISOString());
    ...
    const handleBook = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$dd6b93__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createAppointmentWithDetails"])({
...
//# sourceMappingURL=_dac29a29._.js.map