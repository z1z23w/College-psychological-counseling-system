...
async function submitPsychTest(appointmentId, answers) {
    try {
        ...
        // 2. 计算标准分 (Standard Score) - 中国常模
        // 公式：原始分 * 1.25，取整数
        const sdsScore = Math.floor(sdsRaw * 1.25);
        const sasScore = Math.floor(sasRaw * 1.25);
        // 3. 风险判定逻辑
        // SDS标准: 53-62轻度(黄), 63-72中度(红), >72重度(红)
        // SAS标准: 50-59轻度(黄), 60-69中度(红), >69重度(红)
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].testResult.upsert({
            where: {
                appointmentId: appointmentId // 唯一索引
            },
            create: {
                appointmentId,
                sdsScore,
        ...
        if (isHighRisk) {
            ...
            // B. 标记学生档案风险等级
            const currentApt = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].appointment.findUnique({
                where: {
                    id: appointmentId
                },
                select: {
            ...
            if (currentApt?.studentId) {
                // 只有当新测出的风险等级比原来的高时，才更新（避免把红的更成黄的）
                // 这里简化处理：直接更新为最新状态
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].user.update({
                    where: {
                        id: currentApt.studentId
                    },
                    data: {
                        riskLevel: riskLevel
                    }
...
async function saveAssessment(studentId, score, result) {
    try {
        // 1. 保存测评记录
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].assessment.create({
            data: {
                studentId,
                type: 'PHQ-9',
                score,
...
async function getAssessmentHistory(studentId) {
    try {
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].assessment.findMany({
            where: {
                studentId
            },
            orderBy: {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveAssessment, "700f399bd1f985ae9c27b6497fc48f7a5754b1295e", null);
...
"[project]/.next-internal/server/app/admin/content/editor/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/admin/content/editor/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "407ab247e9c7485991e18a9203d13ca1c8c1535250",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createArticle"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$content$2f$editor$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/admin/content/editor/page/actions.js { ACTIONS_MODULE0 => "[project]/app/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__db441236._.js.map