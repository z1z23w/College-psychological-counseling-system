...
"[project]/app/data:61418f [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:8113bd [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$61418f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:61418f [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$8113bd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:8113bd [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function RiskManagementPage() {
    ...
    const loadData = async ()=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$61418f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getRiskStudents"])();
        setStudents(data);
        setLoading(false);
    };
    ...
    const handleRemind = async (studentId)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$8113bd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendInterventionReminder"])(studentId, currentUser.id, "同学你好，系统检测到你最近压力可能较大，建议来心理中心聊聊，我们随时都在。");
        if (res.success) {
...
//# sourceMappingURL=_65a96508._.js.map