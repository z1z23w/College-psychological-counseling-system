...
"[project]/app/data:96f477 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$96f477__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:96f477 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b51560__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:b51560 [app-ssr] (ecmascript) <text/javascript>");
...
function AssessmentPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('phq9');
    // 加载历史记录
    const fetchHistory = async ()=>{
        if (currentUser?.id) {
            setLoadingHistory(true);
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$b51560__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAssessmentHistory"])(currentUser.id);
        ...
        if (step < selectedTest.questions.length - 1) {
            ...
            if (currentUser?.id) {
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$96f477__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAssessment"])(currentUser.id, total, resultText, selectedTest.id // 存入数据库的是 ID (如 'phq9')
                    );
...
//# sourceMappingURL=_905f0655._.js.map