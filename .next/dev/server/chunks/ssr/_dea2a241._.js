...
"[project]/app/data:e681a1 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:09b40d [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
// ✅ 引入后端 Actions
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$e681a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:e681a1 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$09b40d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:09b40d [app-ssr] (ecmascript) <text/javascript>");
...
function BookingPage() {
    ...
    const [availableSlots, setAvailableSlots] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]); // 当前选中的咨询师在选中日期的可用时间
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (currentUser?.id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$e681a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselors"])().then(setCounselors);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c536c9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAppointments"])(currentUser.id, 'student').then(setMyAppointments);
        }
    }, [
        currentUser,
        activeTab
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchSlots() {
            ...
            // 调用后端查排班
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$066882__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCounselorSchedule"])(targetCounselorId);
            if (res.success) {
                // 过滤出这一天(dayOfWeek)开放的时间段
                const slotsForToday = res.data.filter((s)=>s.dayOfWeek === dayOfWeek).map((s)=>s.timeSlot).sort(); // 排序
    ...
    const handleBook = async ()=>{
        if (!selectedDate || !selectedTime || !targetCounselorId || !currentUser) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("请完善预约信息");
            return;
        }
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$09b40d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createAppointment"])(currentUser.id, targetCounselorId, selectedDate.toISOString(), selectedTime);
        if (res.success) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("预约申请已提交");
            setActiveTab("history"); // 跳到历史记录
            setTargetCounselorId(null); // 关闭弹窗
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("预约失败，该时段可能已被占用");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
...
//# sourceMappingURL=_dea2a241._.js.map