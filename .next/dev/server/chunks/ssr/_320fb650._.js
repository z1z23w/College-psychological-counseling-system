...
"[project]/app/data:766ea7 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:339116 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:39665b [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:9b87d7 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
// ✅ 引入后端所有函数
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$766ea7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:766ea7 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$339116__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:339116 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$39665b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:39665b [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9b87d7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:9b87d7 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function UsersPage() {
    ...
    async function loadData() {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$339116__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUsers"])();
        if (res.success) {
            setUsers(res.data);
        }
        setIsLoading(false);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (editingId) {
            // 编辑模式
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9b87d7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUser"])(editingId, formData);
        } else {
            // 新增模式
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$766ea7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createUser"])(formData);
        }
    ...
    const handleDelete = async (id, userName)=>{
        if (confirm(`确定要永久删除用户 "${userName}" 吗？此操作不可恢复。`)) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$39665b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteUser"])(id);
            if (res.success) {
...
//# sourceMappingURL=_320fb650._.js.map