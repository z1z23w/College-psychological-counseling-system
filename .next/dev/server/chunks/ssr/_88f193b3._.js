...
"[project]/app/data:440cbd [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:bd09fa [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$440cbd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:440cbd [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$bd09fa__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:bd09fa [app-ssr] (ecmascript) <text/javascript>");
...
function AssessmentPage() {
    ...
    const fetchHistory = async ()=>{
        if (currentUser?.id) {
            ...
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$bd09fa__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAssessmentHistory"])(currentUser.id);
        ...
        if (step < selectedTest.questions.length - 1) {
            ...
            if (currentUser?.id) {
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$440cbd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAssessment"])(currentUser.id, total, resultText, selectedTest.id // 存入数据库的是 ID (如 'phq9')
                    );
...
//# sourceMappingURL=_88f193b3._.js.map