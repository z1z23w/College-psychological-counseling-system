...
"[project]/app/data:88485d [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:7b6840 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sonner/dist/index.mjs [app-ssr] (ecmascript)"); // ✅ 引入提示组件
// ✅ 引入后端 Actions
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$88485d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:88485d [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7b6840__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:7b6840 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function AssessmentPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchHistory() {
            if (currentUser?.id) {
                try {
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$7b6840__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAssessmentHistory"])(currentUser.id);
    ...
    const handleAnswer = async (score)=>{
        ...
        if (step < QUESTIONS.length - 1) {
            ...
            if (currentUser?.id) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$88485d__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAssessment"])(currentUser.id, total, total > 10 ? '需关注' : '正常');
...
//# sourceMappingURL=_2bac1fc0._.js.map